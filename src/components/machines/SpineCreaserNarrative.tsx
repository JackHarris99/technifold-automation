        ...
        <section className="mb-12 pb-12 border-b border-slate-200">
          ...
          <div className="md:flex md:gap-8 mb-6">
            ...
            <figure className="md:w-64 mt-6 md:mt-0 flex-shrink-0">
              ...
              />
              <figcaption className="text-xs text-slate-400 mt-2">Fig. 1 — Spine Creaser module</figcaption>
            </figure>
          </div>
        </section>
          ...
          <div className="mb-10">
            ...
            <div className="md:flex md:gap-8">
              ...
              <figure className="md:w-48 mt-4 md:mt-0 flex-shrink-0">
                ...
                <figcaption className="text-xs text-slate-400 mt-1">Perfect spine crease result</figcaption>
              </figure>
            </div>
          </div>
