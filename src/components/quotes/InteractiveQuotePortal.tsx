                      ...
                      <div key={item.product_code} className={`flex items-center gap-4 p-4 rounded-[12px] transition-colors ${
                        ...
                        <div className="flex flex-col items-end gap-1">
                          ...
                          {!readOnly && item.pricing_tier === 'standard' && (
                            <span className="text-[11px] text-[#64748b]">Best pricing up to 15 units</span>
                          )}
                          {!readOnly && item.pricing_tier === 'premium' && (
                            <span className="text-[11px] text-[#64748b]">Best pricing up to 10 units</span>
                          )}
                        </div>
                      </div>
                    );
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-[#1a1a1a] rounded-lg p-4 my-3">
                        <p className="text-[13px] text-[#999] text-center">
                          💡 Shipping and VAT will be calculated upon quote acceptance
                        </p>
                      </div>
                    </div>
