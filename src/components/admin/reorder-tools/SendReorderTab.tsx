...
export default function SendReorderTab() {
  const companyId = null; // No query params in tab view - user will search for company
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                ...
                                <div className="text-xs text-slate-800">Consumables Reorder Portal</div>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex h-96">
                          ...
                          <div className="w-48 bg-white border-r border-slate-200 p-3">
                            ...
                            <div className="space-y-1">
                              ...
                              <div className="px-3 py-2 text-xs text-slate-800 flex items-center gap-2">
