      ...
      <div className="bg-white rounded-lg shadow-lg p-8 mb-6">
        ...
        <div className="flex items-start gap-8">
          ...
          <div className="flex-1">
            ...
            <p className="text-lg text-gray-800 mb-4">{tool.description}</p>
                ...
                {linkedConsumables.map((consumable) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-gray-800 truncate">{consumable.description}</p>
                      <div className="flex items-center gap-3 mt-1">
                        <span className="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded">
                          {consumable.category || 'Uncategorized'}
                        </span>
                        {consumable.price && (
                          <span className="text-xs text-gray-800">£{consumable.price}</span>
                        )}
                      </div>
                    </div>
