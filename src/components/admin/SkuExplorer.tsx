        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <MediaUpload
                mediaType="product"
                identifier={skuDetails.product_code}
                table="products"
                column="image_url"
                recordId={skuDetails.product_code}
                idColumn="product_code"
                currentUrl={skuDetails.image_url}
                label="Product Image"
                type="image"
                onUploadSuccess={(url) => {
                  setSkuDetails(prev => prev ? { ...prev, image_url: url } : null);
                }}
              />
              ...
              <MediaUpload
                ...
                recordId={skuDetails.product_code}
                idColumn="product_code"
                currentUrl={skuDetails.video_url}
                label="Product Video"
                type="video"
                onUploadSuccess={(url) => {
                  setSkuDetails(prev => prev ? { ...prev, video_url: url } : null);
                }}
              />
            </div>
