 ...
 * Shows all subscriptions with filters and anomaly tracking
 */
    ...
    <div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        ...
        <p className="text-sm text-blue-800">
          Track all active subscriptions, trials, and recurring revenue. Monitor ratchet violations to ensure pricing only increases.
        </p>
      </div>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <Link
          ...
          className="bg-blue-600 text-white px-6 py-2 rounded-md hover:bg-blue-700 text-sm font-semibold"
        >
          + Create Subscription
        </Link>
      </div>
      ...
      {!showAnomalies && filteredSubscriptions.length === 0 ? (
        <div className="bg-white rounded-lg shadow-sm p-12 text-center">
          ...
          <Link href="/admin/subscriptions/create" className="inline-block bg-blue-600 text-white px-6 py-2 rounded-md hover:bg-blue-700">
            Create Subscription
          </Link>
        </div>
      ) : !showAnomalies ? (
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Tools</th>
                ...
                <tr key={subscription.subscription_id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    {subscription.stripe_subscription_id && (
                      <div className="text-xs text-gray-700 font-mono">{subscription.stripe_subscription_id.substring(0, 20)}...</div>
                    )}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">{subscription.contact_name || '—'}</div>
                    <div className="text-xs text-gray-700">{subscription.contact_email || '—'}</div>
                  </td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <Link href={`/admin/subscriptions/${subscription.subscription_id}`} className="text-blue-600 hover:text-blue-900">
                      Manage
                    </Link>
                  </td>
                </tr>
      ...
      {/* Summary Stats */}
      {subscriptions.length > 0 && !showAnomalies && (
