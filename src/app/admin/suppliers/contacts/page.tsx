      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <p className="text-3xl font-bold text-cyan-600 mt-2">{supplierContacts.length}</p>
          </div>
          <div className="bg-white rounded-lg shadow-sm p-6">
            <h3 className="text-sm font-medium text-gray-700">Active Suppliers</h3>
            <p className="text-3xl font-bold text-cyan-600 mt-2">
              {new Set(supplierContacts.filter(c => c.companies).map(c => c.companies.company_id)).size}
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-semibold text-gray-900">All Supplier Contacts</h2>
          </div>
