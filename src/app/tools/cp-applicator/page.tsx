        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <div className="bg-white/10 border border-white/20 px-3 py-2 text-center">
              ...
              <div className="text-xs text-gray-800">Closest Perf to Crease</div>
            </div>
            <div className="bg-white/10 border border-white/20 px-3 py-2 text-center">
              <div className="text-2xl font-bold">5x</div>
              <div className="text-xs text-gray-800">Faster Than Letterpress</div>
            </div>
            <div className="bg-white/10 border border-white/20 px-3 py-2 text-center">
              <div className="text-2xl font-bold">World's</div>
              <div className="text-xs text-gray-800">Only Solution</div>
            </div>
            <div className="bg-white/10 border border-white/20 px-3 py-2 text-center">
