...
export default function ResetPasswordWithTokenPage({ params }: { params: Promise<{ token: string }> }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/admin/auth/reset-password-with-token', {
        method: 'POST',
