...
export async function POST(request: NextRequest) {
  try {
    ...
    const { company_id, contact_id, line_items, pricing_mode, quote_type, is_test, created_by, free_shipping, shipping_tbc, requires_approval } = body;
    ...
    const { data: quote, error: quoteInsertError } = await supabase
      ...
      .insert({
        ...
        shipping_tbc: shipping_tbc || false,
