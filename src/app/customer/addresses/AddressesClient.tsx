  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-12">
        ...
        <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg flex items-start gap-3">
          ...
          <div>
            <p className="text-sm text-blue-900 font-medium">
              These are your <strong>shipping/delivery addresses</strong>. To edit your billing address or company details, visit{' '}
              <a href="/customer/account" className="underline font-semibold hover:text-blue-700">
                Account Settings
              </a>.
            </p>
          </div>
        ...
        {/* Encouragement Banner (only show if no addresses) */}
        {addresses.length === 0 && (
          <div className="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-lg flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-amber-900 font-medium mb-1">
                <strong>No shipping addresses yet</strong>
              </p>
              <p className="text-sm text-amber-800">
                Adding a shipping address will make checkout faster. You can still place orders without one - you'll be asked to provide it during checkout.
              </p>
            </div>
          </div>
        )}
